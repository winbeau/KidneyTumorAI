...
if __name__ == '__main__':
    ...
    # For MindSpore, recreate optimizer with different momentum since param_groups doesn't exist
    optimizer = nn.Momentum(params=net.trainable_params(), learning_rate=0.01, momentum=0.95)